...
type HostingItemProps = {
    hostingItems: HostingType[];
};

export const HostingItem = ({ hostingItems }: HostingItemProps) => {
    return (
        <>
            {hostingItems.map(
                ({
                    ...
                    return (
                        <article className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl grid-col-1 lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
