  ...
  return (
    <div className="max-w-6xl max-lg:max-w-3xl mx-auto bg-white">
      <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4">
        <div>
          <h1 className="text-4xl font-semibold text-green-500 mt-6">Contáctanos</h1>
          <p className="text-sm text-gray-500 mt-6 leading-relaxed">
            Es un gusto atenderles, tenemos el espacio ideal para tus vacaciones
          ...
          <ul className="mt-12 space-y-4">
            <li className="flex items-center">
              ...
              <a
                ...
                className="text-green-500 text-base ml-4"
              >
                info@example.com
              </a>
            </li>
